...
import { Tablet, ArrowLeft, ArrowRight, Plus, Minus, Check } from 'lucide-react';
import { getDevicesByCategory } from '../data/devices.js';

const DataLinesFlow = ({ data, onDataChange, onComplete, onPrev, onNext }) => {
  ...
  const steps = [
    { id: 'quantity', title: 'Quantity', description: 'How many data lines?' },
    { id: 'devices', title: 'Devices', description: 'Select tablets and wearables' },
    { id: 'plans', title: 'Plans', description: 'Choose data plans' },
  ...
  const wearableDevices = getDevicesByCategory('wearable');
  ...
  const dataPlans = [
    ...
    },
    {
      ...
      name: '10GB Data',
      price: 10,
      features: ['10GB high-speed data', '5G access', 'Mobile hotspot']
    },
    {
      id: '5gb-data',
      name: '5GB Data',
      price: 5,
      features: ['5GB high-speed data', '5G access', 'Mobile hotspot']
    }
  ];
  ...
  const protectionOptions = [
    {
      ...
      price: 15,
      features: ['Device replacement', 'Screen repair', 'Extended warranty']
    },
    {
      id: 'basic-protection',
  ...
  const renderQuantityStep = () => (
    <div style={{ padding: '20px' }}>
      <h3 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '20px', color: '#333' }}>
        How many data lines do you need?
      </h3>
      ...
      <p style={{ textAlign: 'center', color: '#666', marginTop: '20px' }}>
        Data lines are for tablets and wearables
      </p>
    </div>
  );
  ...
  const renderDevicesStep = () => (
    <div style={{ padding: '20px' }}>
      <h3 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '20px', color: '#333' }}>
        Select devices for each data line
      </h3>
  ...
  const renderPlansStep = () => (
    <div style={{ padding: '20px' }}>
      <h3 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '20px', color: '#333' }}>
        Select data plans for each line
      </h3>
      {Array.from({ length: data.quantity || 0 }, (_, index) => (
        <div key={index} style={{ marginBottom: '30px' }}>
          <h4 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '15px', color: '#666' }}>
            Data Line {index + 1} Plan
          </h4>
  ...
  const renderPromotionsStep = () => (
    <div style={{ padding: '20px' }}>
      <h3 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '20px', color: '#333' }}>
        Available promotions for data lines
      </h3>
      {Array.from({ length: data.quantity || 0 }, (_, index) => (
        <div key={index} style={{ marginBottom: '30px' }}>
          <h4 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '15px', color: '#666' }}>
            Data Line {index + 1} Promotions
          </h4>
          <div style={{
            background: '#f8f9fa',
            padding: '20px',
            ...
            <div style={{ fontSize: '14px', color: '#666', textAlign: 'center' }}>
              ...
              <div>Watch/Tablet/Laptop $5 Off</div>
              <div style={{ fontSize: '12px', marginTop: '5px' }}>
                Automatic discount applied to eligible devices
              </div>
            </div>
          </div>
        </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#666', fontSize: '14px', margin: 0, lineHeight: '1.4' }}>
          Configure tablets and wearables for your account.
        </p>
