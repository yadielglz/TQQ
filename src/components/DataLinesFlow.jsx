...
import { Tablet, ArrowLeft, ArrowRight } from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{ flex: 1, padding: '40px 20px', textAlign: 'center' }}>
        <div style={{
          ...
          <Tablet size={60} color="#E20074" style={{ marginBottom: '20px' }} />
          ...
          <div style={{
            ...
            ℹ️ Data Lines configuration coming soon
          </div>
        </div>
      </div>
