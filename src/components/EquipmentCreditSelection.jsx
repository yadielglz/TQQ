...
const EquipmentCreditSelection = ({ data, onDataChange, onNext, onPrev }) => {
  return (
    <div style={{
      maxWidth: '100%',
      margin: '0 auto',
      ...
      <div style={{
        ...
        <p style={{ color: '#666', fontSize: '14px', margin: 0, lineHeight: '1.4' }}>
          Apply equipment credits and trade-in values to your quote.
        </p>
      </div>
      ...
      <div style={{ flex: 1, padding: '40px 20px', textAlign: 'center' }}>
        <div style={{
          ...
          <CreditCard size={60} color="#E20074" style={{ marginBottom: '20px' }} />
          <h3 style={{ fontSize: '20px', fontWeight: '600', color: '#333', marginBottom: '12px' }}>
            Equipment Credit Configuration
          </h3>
          ...
          <div style={{
            ...
            ℹ️ Equipment Credit configuration coming soon
          </div>
        </div>
      </div>
